...
public class ShoppingView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mPaintMinus.setStrokeWidth(3);
//        mPaintMinus.setStrokeWidth(textSize / 6);
        mPaintText = new Paint();
        mPaintText.setColor(Color.WHITE);
        mPaintText.setStrokeWidth(textSize / 10);
        mPaintText.setTextSize(textSize);
        mPaintText.setAntiAlias(true);
        mPaintNum = new Paint();
        mPaintNum.setColor(Color.BLACK);
        mPaintNum.setTextSize(textSize);
    ...
    private void drawAddBtn(Canvas canvas) {
        canvas.drawCircle(MAX_WIDTH - MAX_HEIGHT / 2, MAX_HEIGHT / 2, MAX_HEIGHT / 5 * 2, mPaintBg);
    ...
    private void drawMinusBtn(Canvas canvas, float angle) {
        ...
        canvas.drawCircle(mMinusBtnPosition, MAX_HEIGHT / 2, MAX_HEIGHT / 5 * 2, mPaintMinus);
